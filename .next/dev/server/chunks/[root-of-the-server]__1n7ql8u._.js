...
async function POST(req) {
    try {
        ...
        const comparisonContext = previousScan ? `This is a REPEAT PROGRESS SCAN for a returning user. 
         ...
         Analyze this new selfie, compare it directly to their previous baseline, and evaluate structural shifts (e.g. reduction in water retention, jawline definition changes).` : `This is an initial baseline assessment for a new user.`;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1n7ql8u._.js.map